...
async fn handler(
    ...
    resp.push_str("Hello, I am a [code review bot](https://afterfit.co.jp/). Here are my reviews of code commits in this PR.\n\n------\n\n");
    if reviews.len() > 1 {
